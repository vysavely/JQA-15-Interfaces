...
public class AviaSoulsTest {
    ...
    Ticket ticket3 = new Ticket("Пермь", "Санкт-Питербург", 5_000, 9, 13);
    Ticket ticket4 = new Ticket("Санкт-Питербург", "Пермь", 4_000, 16, 17);
    ...
    public void shouldSearchOneTicketWithComparator() {
        ...
        Assertions.assertArrayEquals(new Ticket[]{ticket4}, fly.searchAndSortBy("Санкт-Питербург", "Пермь", comparator));
    }
